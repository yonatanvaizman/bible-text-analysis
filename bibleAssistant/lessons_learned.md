...
- I don't want the system prompt to be decoupled from which model is used.
- Can I list the tools in the system prompt in a more abstract way (e.g., use the docstring)?
